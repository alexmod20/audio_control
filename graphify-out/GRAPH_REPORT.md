# Graph Report - audio_control  (2026-07-14)

## Corpus Check
- 47 files · ~13,996 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 343 nodes · 342 edges · 56 communities (24 shown, 32 thin omitted)
- Extraction: 97% EXTRACTED · 3% INFERRED · 0% AMBIGUOUS · INFERRED: 10 edges (avg confidence: 0.89)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `36be0789`
...
5. `dart:async` - 7 edges
6. `Task 8: Minor cleanups` - 7 edges
...
Cohesion: 0.08
Nodes (25): audio_control_method_channel.dart, package:audio_control/audio_control_method_channel.dart, package:audio_control/audio_control_platform_interface.dart, package:audio_control/media_app_details.dart, package:audio_control/media_info.dart, package:flutter_test/flutter_test.dart, package:plugin_platform_interface/plugin_platform_interface.dart, AudioControlPlatform (+17 more)
...
Cohesion: 0.11
Nodes (16): package:audio_control/audio_control.dart, package:audio_control_example/dashboard_page.dart, package:audio_control_example/main.dart, package:flutter/material.dart, package:flutter/services.dart, AppCard, build, Card (+8 more)
...
Cohesion: 0.21
Nodes (10): audio_control_platform_interface.dart, dart:async, media_app_details.dart, media_info.dart, AudioControl, setSessionChangedListener, setSessionDestroyedListener, setStateChangeListener (+2 more)
...
Cohesion: 0.18
Nodes (9): Architecture, code:bash (flutter pub get                     # fetch plugin dependenc), code:bash (cd example), code:bash (cd android), Commands, graphify, Key constraint: the notification listener permission, State flow for "now playing" data (+1 more)

### Community 12 - "Media App Discovery Utilities"
Cohesion: 0.48
...
### Community 15 - "Notification Access Check"
Cohesion: 0.33
...
### Community 16 - "MediaAppDetails Serialization"
Cohesion: 0.33
Nodes (5): code:kotlin (package com.alexmod.audio_control), code:kotlin (import kotlinx.coroutines.CoroutineDispatcher), code:kotlin ("getMediaApps" -> audioControl.getMediaAppsAsync(mContext) {), code:bash (git add android/src/main/kotlin/com/alexmod/audio_control/Au), Task 7: Move `getMediaApps()` icon/banner conversion off the main thread
...
## Knowledge Gaps
- **158 isolated node(s):** `_BareAudioControlPlatform`, `main`, `main`, `simulateNativeCall`, `MockAudioControlPlatform` (+153 more)
...
- **Why does `dart:async` connect `AppCard Widget & Models` to `Example Player Page UI`, `Plugin Architecture & Dependencies`, `Example Dashboard & Lifecycle`?**
  _High betweenness centrality (0.026) - this node is a cross-community bridge._
- **Why does `Android Native Hardening Implementation Plan` connect `Plugin Public API & Tests` to `MediaAppDetails Serialization`, `Notification Access Check`?**
  _High betweenness centrality (0.018) - this node is a cross-community bridge._
- **Why does `package:flutter/foundation.dart` connect `Example Dashboard & Lifecycle` to `AppCard Widget & Models`, `Plugin Architecture & Dependencies`, `Method Channel Platform Bridge`?**
...
- **What connects `_BareAudioControlPlatform`, `main`, `main` to the rest of the system?**
